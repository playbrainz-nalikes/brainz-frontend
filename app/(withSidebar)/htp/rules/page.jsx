...
export default function GameRulesPage() {
  return (
    <div>
      ...
      <ul className="text-2xl space-y-6 list-disc pl-7 mb-24">
      ...
      <div className="flex flex-col w-full lg:flex-row gap-14 mb-[90px]">
      ...
      <div>
        ...
        <p className="font-black text-2xl mb-[34px]">
...
const RuleCard1 = ({ title, children }) => {
  return (
    ...
    >
      <h4 className="text-2xl font-black mb-[21px]">{title}</h4>
    ...
    <div className="px-5 py-7 flex-1 rounded-[5px] bg-gradient-to-r from-[#06262c] to-[#05212a]">
      <div className="flex justify-between mb-[21px]">
        ...
        <div className="px-3 bg-success/20 rounded-[80px] flex items-center gap-2 ">
          <p className="text-base lg:text-xl">01</p>
